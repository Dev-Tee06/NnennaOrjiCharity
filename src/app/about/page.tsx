...
const PEOPLE = [
  {
    ...
    desc: "Leads all NOCF’s communication strategy, growth, public messaging and stakeholder communications.",
    image: "/images/volunteer-image1.jpg",
  },
  {
    name: "Bethel Ugwu",
    role: "HEAD OF FINANCE",
    desc: "Oversees financial planning, budgeting, records and financial accountability across NOCF’s activities.",
    image: "/images/volunteer-image3.jpg",
  },
  {
    name: "David Orji",
    role: "KANO HUB LEAD",
    desc: "Coordinates NOCF’s Kano operations, outreach logistics, community engagement and local volunteer teams.",
    image: "/images/volunteer-image2.jpg",
  },
  {
    name: "Nora Anucha",
    role: "PLACEMENT & TICKETING ",
    desc: "Manages beneficiary registration, placement and ticketing to ensure orderly and accurate distribution.",
    image: "/images/volunteer-image6.png",
  },
  {
    name: "Genevieve Atanmoh",
    role: "LEAD, INVENTORY",
    desc: "Oversees the receipt, tracking, sorting and allocation of food, clothing and other donated items.",
