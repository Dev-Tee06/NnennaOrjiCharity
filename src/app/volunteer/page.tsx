...
const VOLUNTEER_STEPS = [
  {
    ...
    description:
      "Complete the application form. A programme coordinator calls within a week and matches you to a station: sorting, kitchen, logistics or documentation.",
  ...
  },
  {
    ...
    description:
      "Through November and December you join sorting weekends and packing sessions. Roughly two Saturdays per month, four to six hours each.",
  ...
  },
  {
    ...
    title: "Outreach day",
    description:
      "26 December. Vans load before sunrise, routes are assigned in teams of four, and every box is handed over in person. The day ends by mid-afternoon.",
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-20 items-center">
          <div className="flex flex-col items-start w-full order-1 lg:order-1">
            <div className="flex items-center gap-2 bg-white border border-border px-3 py-1.5 rounded-full w-fit mb-6">
              <span className="font-heading font-bold text-[13px] text-orangeRed1">
                500+
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 w-full sm:w-auto">
              ...
              <Button
                href="/about"
                variant="outline"
                className="w-full sm:w-auto px-6 bg-white border-border"
              >
                Meet the team
              </Button>
            </div>
          ...
          <div className="w-full order-2 lg:order-2">
            <div className="relative aspect-[1.4/1] w-full rounded-[7px] overflow-hidden bg-border">
              <Image
                src="/images/volunteer-image.jpg"
                alt="Volunteers"
                fill
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 xl:px-12">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-6">
            {VOLUNTEER_STEPS.map((step) => (
              <div
                key={step.number}
                className="bg-white border border-border rounded-[10px] p-8 lg:p-10 flex flex-col relative overflow-hidden group"
              >
                {/* Background Number */}
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  ...
                  <h3 className="font-heading font-bold text-[22px] text-blackKnight mb-4">
                    {step.title}
                  </h3>
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 xl:px-12 flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start w-full order-1 lg:order-2">
            ...
            <p className="font-body text-base lg:text-[17px] text-text-secondary leading-[1.6] mb-8">
              We keep teams small and named. Every route has a lead, every
              station has a checklist, and every volunteer signs the delivery
              sheet they worked on. Nobody disappears into a crowd, and nobody
              carries the day alone.
            </p>
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 xl:px-12">
          <div className="bg-blackKnight rounded-[16px] p-8 md:p-12 lg:p-20 relative overflow-hidden flex flex-col items-start lg:items-center lg:text-center">
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/bg-drop.jpg')",
            ...
            <div className="relative z-10 w-full flex flex-col lg:items-center">
              ...
              <p className="font-body text-base lg:text-[18px] text-white/70 leading-[1.6] max-w-[700px] mb-10">
                We ask for your name, city, availability window and whether you
                can lift, cook, drive or document. That is all. Applications for
                the December outreach close on 10 December.
              </p>
