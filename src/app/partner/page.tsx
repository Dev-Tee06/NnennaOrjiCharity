...
import { Building2, Package, Megaphone, Handshake, ArrowRight } from 'lucide-react';
...
export default function Partner() {
  ...
  const isValid = formData.organisationName.trim() !== '' && 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (isValid) {
      alert("Enquiry sent successfully. We'll get back to you within three working days.");
      setFormData({
        organisationName: '',
        representative: '',
        email: '',
    ...
    <div className="bg-offWhite pb-24 min-h-screen">
      ...
      <section className="pt-24 md:pt-32 pb-16 px-4 md:px-8 xl:px-12 max-w-[1320px] mx-auto flex flex-col items-center text-center">
        <div className="flex items-center gap-2 bg-white border border-border px-4 py-1.5 rounded-full w-fit mb-8">
          ...
          <span className="font-body text-[13px] text-blackKnight font-medium">For companies, brands & NGOs</span>
        </div>
        ...
        <p className="font-body text-base md:text-[17px] text-text-secondary mt-6 max-w-[760px] leading-[1.6]">
          NOCF is small enough to be accountable and established enough to deliver at scale. A partnership here does not buy a logo on a banner — it buys a documented delivery run with names, counts and photographs attached to your contribution.
        </p>
      </section>
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 xl:px-12">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-4 gap-4 lg:gap-5">
            {PARTNERSHIP_AVENUES.map((card, i) => (
              <div key={i} className="bg-white border border-border rounded-[12px] p-6 lg:p-8 flex flex-col gap-5 transition-shadow hover:shadow-sm">
        ...
        <div className="max-w-[1320px] mx-auto px-4 md:px-8 xl:px-12 flex flex-col lg:grid lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-16 lg:items-center">
          ...
          <div className="flex flex-col items-start w-full">
            ...
            <p className="font-body text-[16px] lg:text-[17px] text-text-secondary leading-[1.6] mb-10 max-w-[500px]">
              Partnership enquiries are answered by a member of the board within three working days. We are happy to share our annual report and delivery data before you commit to anything.
            </p>
            
            <div className="flex flex-col w-full max-w-[500px]">
              {[
                { label: "TYPICAL LEAD TIME", value: "6–10 weeks before a December outreach" },
                { label: "MINIMUM SPONSORSHIP", value: "100 boxes (₦1.25M) or equivalent in kind" },
                { label: "REPORTING", value: "Itemised spend, delivery manifest, photography" },
              ].map((item, i) => (
                <div key={i} className="flex flex-col py-4 border-b border-border-subtle last:border-0 last:pb-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="flex flex-col md:grid md:grid-cols-2 gap-5">
                <div className="flex flex-col gap-1.5">
                  <label className="font-body text-[13px] font-semibold text-blackKnight">Organisation name</label>
                  <input 
                    type="text" 
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="font-body text-[13px] font-semibold text-blackKnight">Representative</label>
                  <input 
                    type="text" 
              ...
              <div className="flex flex-col gap-1.5">
                <label className="font-body text-[13px] font-semibold text-blackKnight">Email address</label>
                <input 
                  type="email" 
              ...
              <div className="flex flex-col gap-1.5">
                <label className="font-body text-[13px] font-semibold text-blackKnight">Partnership type</label>
                <select 
                ...
                >
                  ...
                  <option value="Outreach Sponsorship">Outreach Sponsorship</option>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="font-body text-[13px] font-semibold text-blackKnight">Message</label>
                <textarea 
