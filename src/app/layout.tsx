...
export const metadata: Metadata = {
  ...
  keywords: ["Charity", "Foundation", "Nigeria", "Lagos", "Kano", "NGO", "Donation", "Box of Hope", "Project 26", "Nnenna Orji Charity Foundation"],
  openGraph: {
    title: "Nnenna Orji Charity Foundation",
    description: "Sharing Love Everywhere With A Box Full of Hope. Join our mission to deliver essential resources across Nigeria.",
    url: "https://nocf.org",
